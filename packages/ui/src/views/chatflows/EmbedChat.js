...
const embedPopupHtmlCode = (chatflowid) => {
    ...
    import Chatbot from "https://cdn.jsdelivr.net/npm/@exdatic/flowise-embed/dist/web.js"
    Chatbot.init({
...
const embedPopupReactCode = (chatflowid) => {
    return `import { BubbleChat } from '@exdatic/flowise-embed-react'
...
const embedFullpageReactCode = (chatflowid) => {
    return `import { FullPageChat } from "@exdatic/flowise-embed-react"
                            ...
                            <span>
                                ...
                                <p>
                                    ...
                                    <a
                                        rel='noreferrer'
                                        target='_blank'
                                        href='https://www.npmjs.com/package/@exdatic/flowise-embed?activeTab=versions'
                                    >
                                        version
                                    </a>
                                    :&nbsp;<code>{`https://cdn.jsdelivr.net/npm/@exdatic/flowise-embed@<version>/dist/web.js`}</code>
                                </p>
                            </span>
