...
import { createRetrieverWithSourcesTool } from './createRetrieverWithSourcesTool'
import { BaseRetriever } from 'langchain/schema/retriever'

class RetrieverWithSources_Tools implements INode {
    label: string
    name: string
    version: number
    description: string
    ...
    async init(nodeData: INodeData): Promise<any> {
        ...
        const tool = createRetrieverWithSourcesTool(retriever, {
            name,
            description
        })
...
module.exports = { nodeClass: RetrieverWithSources_Tools }
